...
When using [`@gnss_*` or `@position_` variables](../gnss.md#additional-variables) on averaged positions, the variable will also represent the average over all collected samples.
