...
!!! Workflow
    ...
    !![](../../assets/images/geofencing-settings.png)
     ...
     6. Save your project and transfer it to your device.

:material-tablet: Fieldwork

By default when synchronizing your project, QField will adopt the geofencing rules.

When the alert is on, a glowing read circle will appear at the bottom right corner of your device's screen.
