...
!!! Workflow
    ...
    - **Map Context Menu:** Long-press on the part of the map to which you wish to navigate to and select the *Set as Destination* action within the pop-up menu.
...
!!! Workflow
    ...
    1. Tap on the positioning button and the navigation control button.
...
!!! Workflow
    ...
    You can modify the precision threshold and enable the audio feedback from the configuration menu.

    1. To open it, tap on the **Side Dashboard**.
