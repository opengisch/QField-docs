# -*- coding: utf-8 -*-
#
# QField documentation build configuration file, created by
...
# ones.
extensions = ['edit_on_github', 'vimeo', 'redirects', 'sphinxcontrib.video']
...
copyright = u'2019, The QField Project/OPENGIS.ch'
...
# of the sidebar.
html_logo = '_static/qfield-logo.svg'

# The name of an image file (within the static path) to use as favicon of the
# docs.  This file should be a Windows icon file (.ico) being 16x16 or 32x32
# pixels large.
html_favicon = '_static/qfield-logo-noborder.ico'
...
latex_documents = [
  ('index', 'QField.tex', u'QField Documentation',
   u'The QField Project/OPENGIS.ch', 'manual'),
]
...
man_pages = [
    ('index', 'QField', u'QField Documentation',
     [u'The QField Project/OPENGIS.ch'], 1)
]
...
texinfo_documents = [
  ('index', 'QField', u'QField Documentation',
   u'The QField Project/OPENGIS.ch', 'QField', 'One line description of project.',
   'Miscellaneous'),
]
